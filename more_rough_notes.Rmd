...
sensor_details %<>%  bind_rows(
      missing_sensors[1:5000,] %>%
      group_by(first_day,sensor_file,file_url) %>%
...
ggplot() +
  ...
  geom_count(data=sensor_details,aes(x = lon, y = lat),alpha=.3,colour="blue")+
